...
title: "Linux常用命令"
description:
date: 2021-12-20T03:06:49+08:00
image: Windows.png
categories:
    - shell
---
...
| usermod -s /bin/ksh -d /home/codepig –g dev twac | 修改⽤户twac的登录Shell、主⽬录以及⽤户组 |
...
| passwd                                                | 修改⼝令                                       |
| passwd twac                                      | 修改某⽤户的⼝令                               |
| w                                                     | 查看活动⽤户                                   |
| id twac                                          | 查看指定⽤户twac信息                      |
| last                                                  | 查看⽤户登录⽇志                               |
...
| grep twac hello.txt      | 在⽂件hello.txt中查找关键词twac    |
